...
public class BookingControllerTest {
    ...
    void mustCreateBooking() throws Exception {
        ...
        mvc.perform(post("/bookings")
                ...
                .andExpect(jsonPath("$.start[0]", is(2025)))
                .andExpect(jsonPath("$.start[1]", is(7)))
                .andExpect(jsonPath("$.start[2]", is(20)))
                .andExpect(jsonPath("$.start[3]", is(10)))
                .andExpect(jsonPath("$.start[4]", is(0)))
                .andExpect(jsonPath("$.end[0]", is(2025)))
                .andExpect(jsonPath("$.end[1]", is(7)))
                .andExpect(jsonPath("$.end[2]", is(20)))
                .andExpect(jsonPath("$.end[3]", is(12)))
                .andExpect(jsonPath("$.end[4]", is(0)))
                .andExpect(jsonPath("$.id", is(1)))
    ...
    void mustReturnUserBookings() throws Exception {
        ...
        mvc.perform(get("/bookings")
                ...
                .andExpect(jsonPath("$[0].start[0]", is(2025)))
                .andExpect(jsonPath("$[0].start[1]", is(7)))
                .andExpect(jsonPath("$[0].start[2]", is(20)))
                .andExpect(jsonPath("$[0].start[3]", is(10)))
                .andExpect(jsonPath("$[0].start[4]", is(0)))
                .andExpect(jsonPath("$[0].end[0]", is(2025)))
                .andExpect(jsonPath("$[0].end[1]", is(7)))
                .andExpect(jsonPath("$[0].end[2]", is(20)))
                .andExpect(jsonPath("$[0].end[3]", is(12)))
                .andExpect(jsonPath("$[0].end[4]", is(0)))
                ...
                .andExpect(jsonPath("$[1].start[0]", is(2025)))
                .andExpect(jsonPath("$[1].start[1]", is(7)))
                .andExpect(jsonPath("$[1].start[2]", is(20)))
                .andExpect(jsonPath("$[1].start[3]", is(13)))
                .andExpect(jsonPath("$[1].start[4]", is(0)))
                .andExpect(jsonPath("$[1].end[0]", is(2025)))
                .andExpect(jsonPath("$[1].end[1]", is(7)))
                .andExpect(jsonPath("$[1].end[2]", is(20)))
                .andExpect(jsonPath("$[1].end[3]", is(14)))
                .andExpect(jsonPath("$[1].end[4]", is(0)))

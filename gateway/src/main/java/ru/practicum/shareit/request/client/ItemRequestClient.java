...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> findListOfRequestsOtherUsers(Long userId, int from, int size) {
        Map<String, Object> parameters = Map.of("from", from, "size", size);

        return get("/all?from={from}&size={size}", userId, parameters);
    }

    public ResponseEntity<Object> findYourQueryWithAnswers(Long userId, Long requestId) {
